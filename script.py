...
with open('/RickeyMorty/json/rick_morty-episodes_v1.json',encoding="utf8") as json_data:
...
with open('/RickeyMorty/json/rick_morty-characters_v1.json',encoding="utf8") as json_data:
    data_dict = json.load(json_data)
